    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
            ...
            Flexible(
              child: ListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 40.0, vertical: 15.0),
              title: Padding(padding: const EdgeInsets.only(bottom: 5.0),
                child: Text("못말리는상어", style: TextStyle(color: Color(0xff459B99), fontWeight : FontWeight.w800))),
              subtitle: Text("어렵지 않아요. 꼭 편지가 들어가야 선물은 아니잖아요."),
            )),
            Flexible(
              child: ListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 40.0, vertical: 0),
              title: Padding(padding: const EdgeInsets.only(bottom: 5.0),
                child: Text("요리가 취미", style: TextStyle(color: Color(0xff459B99), fontWeight : FontWeight.w800))),
