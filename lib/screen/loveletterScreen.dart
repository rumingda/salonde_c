      ...
      home: DefaultTabController(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
              ...
              child: ListTile(  
                leading: Container(child: Image.asset(images[index])),
                title: Padding(padding: EdgeInsets.fromLTRB(0, 15, 0, 10), child: Text(("강살롱님에게" + points[index] + "점을 받았어요!"))),
                subtitle: Padding(padding: EdgeInsets.fromLTRB(0, 0, 0, 15), child:Text(loveletters[index], style: TextStyle(color: Color(0xffC4C4C4)))),
