...
import 'package:salondec/data/agora_setting.dart' as config;
...
class _RtmpStreamingState extends State<RtmpStreaming> {
  ...
  String channelId = config.channelName;
  bool isJoined = false;
  ...
  Future<void> _initEngine() async {
    _engine = await RtcEngine.createWithContext(RtcEngineContext(config.APP_ID));
    _addListeners();
  ...
  Future<void> _joinChannel() async {
    ...
    await _engine.joinChannel(config.APP_TOKEN, channelId, null, config.uid);
  }
