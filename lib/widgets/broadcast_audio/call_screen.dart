...
import 'package:salondec/widgets/broadcast_audio/user_view.dart';
...
class CallScreen extends StatefulWidget {
  ...
  CallScreen({required this.channelName, required this.userName, required this.role});
  ...
  void _createClient() async {
    ...
    for (var i = 0; i < _users.length; i++) {
      if (_allUsers.containsKey(_users[i])) {
        setState(() {
          _broadcaster.add('${_allUsers.values}');
        });
      } else {
        setState(() {
