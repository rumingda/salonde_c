...
/**
 ...
 @return An [AgoraRtmMessage]([AgoraRtmMessage]) instance.
...
/**
 Attributes of a peer-to-peer or channel raw message. Inherited from [AgoraRtmMessage]([AgoraRtmMessage]).
 */
...
/**
 Creates and initializes an [AgoraRtmRawMessage]([AgoraRtmRawMessage]) instance.
 ...
 @return An [AgoraRtmRawMessage]([AgoraRtmRawMessage]) instance.
 */
- (instancetype _Nonnull)initWithRawData:(NSData * _Nonnull)rawData description:(NSString * _Nonnull)description;
@end

/**
 The interface for setting and retrieving attributes of a file message. Inherited from [AgoraRtmMessage]([AgoraRtmMessage]).
 */
...
typedef NS_OPTIONS(NSUInteger, AgoraRtmAreaCode) {
   ...
   * Mainland China.
   */
  AgoraRtmAreaCodeCN = (1 << 0),

  /**
   * North America.
   */
  AgoraRtmAreaCodeNA = (1 << 1),

  /**
   * Europe.
   */
  AgoraRtmAreaCodeEU = (1 << 2),

  /**
   * Asia excluding Mainland China.
   */
  AgoraRtmAreaCodeAS = (1 << 3),

  /**
   * Japan.
   */
  AgoraRtmAreaCodeJP = (1 << 4),

  /**
   * India.
   */
  AgoraRtmAreaCodeIN = (1 << 5),
...
/**
 * Type of the cloud proxy. The default is `AgoraRtmNoneProxy`. See [AgoraRtmCloudProxyType](AgoraRtmCloudProxyType).
 */
...
/**
 ...
 You are required to renew your Token when receiving the [rtmKitTokenDidExpire]([AgoraRtmDelegate rtmKitTokenDidExpire:]) callback, and the [AgoraRtmRenewTokenBlock](AgoraRtmRenewTokenBlock) callback returns the result of this method call. The call frequency limit for this method is two calls per second.
...
/**
 Returns the result of the [joinWithCompletion]([AgoraRtmChannel joinWithCompletion:]) method call. <p><i>errorCode:</i> See [AgoraRtmJoinChannelErrorCode]([AgoraRtmJoinChannelErrorCode]) for the error codes.
 */
typedef void (^AgoraRtmJoinChannelBlock)(AgoraRtmJoinChannelErrorCode errorCode);

/**
 Returns the result of the [leaveWithCompletion]([AgoraRtmChannel leaveWithCompletion:]) method call. <p><i>errorCode:</i> See [AgoraRtmLeaveChannelErrorCode]([AgoraRtmLeaveChannelErrorCode]) for the error codes.
 */
typedef void (^AgoraRtmLeaveChannelBlock)(AgoraRtmLeaveChannelErrorCode errorCode);

/** Returns the result of the [sendMessage]([AgoraRtmChannel sendMessage:completion:]) method call. <p><i>errorCode:</i> See [AgoraRtmSendChannelMessageErrorCode]([AgoraRtmSendChannelMessageErrorCode]) for the error codes.
*/
typedef void (^AgoraRtmSendChannelMessageBlock)(AgoraRtmSendChannelMessageErrorCode errorCode);

/**
 Returns the result of the [getMembersWithCompletion]([AgoraRtmChannel getMembersWithCompletion:]) method call. <p><li><i>members:</i> The member list. See [AgoraRtmMember]([AgoraRtmMember]). <li><i>errorCode:</i> See [AgoraRtmGetMembersErrorCode]([AgoraRtmGetMembersErrorCode]) for the error codes.
*/
 ...
 **NOTE**
 ...
 @param completionBlock [AgoraRtmSendChannelMessageBlock](AgoraRtmSendChannelMessageBlock) returns the result of this method call. See [AgoraRtmSendChannelMessageErrorCode]([AgoraRtmSendChannelMessageErrorCode]) for the error codes.
 */
- (void)sendMessage:(AgoraRtmMessage * _Nonnull)message
